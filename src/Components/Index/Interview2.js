...
function InterviewText () {
  return (
    <div>
      <p className={styles.q}>
        В конце мая премьер-министр РФ Михаил Мишустин подписал распоряжение о создании в Дзержинске особой экономической зоны (ОЭЗ) «Кулибин».
        Почему была выбрана именно эта площадка, сколько времени ушло на ее создание, с какими сложностями пришлось столкнуться? Во сколько обошелся региону процесс создания ОЭЗ и была ли оказана поддержка из федерального бюджета?
      </p>
