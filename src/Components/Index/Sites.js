...
function ToserText () {
  return (
    <div>
      ...
      <p>
        С момента организации ТОСЭР прошел всего год, а их резидентами стали уже четыре компании. В Володарске в июне 2019 года ООО «Корпорация „Руслен-конопля“» начало строить завод по первичной и глубокой переработке льна. Инвестиции в проект составили 83,7 млн руб. На эти деньги компания возводит корпуса, закупает оборудование и запускает производство. Проектная мощность предприятия — более 1 тыс. т специально обработанной льняной соломы в год. Для реализации проекта компании выделили участок площадью 22 га: 2,2 га — для организации первичной переработки льна, 19,8 га — для строительства логистического комплекса, где будет храниться сырье и готовая продукция, и производства по глубокой переработке льна.
      </p>

      <p>
        По планам строительство производственной линии по первичной переработке льна займет 22 месяца, и столько же времени уйдет на организацию производства глубокой переработки. В качестве сырья планируется использовать как лен, выращенный «Корпорацией „Руслен-конопля“», так и другими нижегородскими сельхозпроизводителями, говорит исполнительный директор компании Сергей Потехин. Готовую продукцию планируется продавать внутри России и на экспорт: у компании заключены договоры на поставку продукции изо льна с предприятиями из Китая и Белоруссии.
      </p>
