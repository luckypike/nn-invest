  ...
  return (
    <div className={styles.root}>
      ...
      <div className={styles.sites_container}>
        ...
        <Link to="/toser/1" className={styles.sites_link} onClick={() => setOverlay(true)}>
...
function ToserText () {
  return (
    <div>
      <p><strong><em>История вопроса</em></strong></p>
      ...
      <p><strong><em>Прогрессивный подход</em></strong></p>
      ...
      <p><strong>Льготы, бонусы и преференции</strong></p>
