    ...
    <div className={styles.root}>
      ...
      <div className={styles.leaders_container}>
        <div className={styles.f}>
          В структуре промышленности региона обрабатывающие производства занимают около 90%, благодаря чему экономика Нижегородской области слабо зависит от сырьевых рынков. Поэтому крупнейшие мировые промышленные компании выбирают Нижегородскую область для размещения своих предприятий.
        </div>
