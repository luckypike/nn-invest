...
function StairsText () {
  return (
    <div>
      ...
      программах для выплаты зарплаты сотрудникам» - отметил <strong>Тимур Халитов</strong>.<br /><br />
      ...
      губернатор Нижегородской области <strong>Глеб Никитин</strong>.<br /><br />
...
function FairText () {
  return (
    <div>
      ...
      Нижегородской области.<br /><br /> Всего назначены 82 инвестиционных
      ...
      местах. <br /><br /> <strong>Глеб Никитин</strong> подчеркнул, что в текущей ситуации особо важен
      прямой выход инвесторов на инвестиционных уполномоченных <em>(список
      инвеступолномоченных с контактами – в приложении)</em>.<br /><br />
      ...
      реагировать на запросы», - отметил губернатор.<br /><br />
      Кроме того, получить консультацию предприниматели могут,
      обратившись на <strong>горячую линию поддержки инвесторов</strong>: 8 (800) 350-12-52.<br /><br />
      ...
      области <strong>Тимур Халитов</strong>. <br /><br />
