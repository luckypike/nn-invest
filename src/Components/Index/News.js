...
function StairsText () {
  return (
    <div>
      ...
      программах для выплаты зарплаты сотрудникам» - отметил Тимур Халитов.
...
function FairText () {
  return (
    <div>
      ...
      по поручению губернатора Глеба Никитина в 2019 году. Координатором
      работы инвеступолномоченных выступает Корпорация развития
      Нижегородской области. Всего назначены 82 инвестиционных
      ...
      местах.
      Глеб Никитин подчеркнул, что в текущей ситуации особо важен
      прямой выход инвесторов на инвестиционных уполномоченных (список
      инвеступолномоченных с контактами – в приложении).
      ...
      обратившись на горячую линию поддержки инвесторов: 8 (800) 350-12-52.
